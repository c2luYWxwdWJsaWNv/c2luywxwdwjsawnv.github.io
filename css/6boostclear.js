...
const substitutionLinks = [
  "https://balofa5423.balofa5423.workers.dev/", 
  "https://curly-math-42b3.mikavi7999.workers.dev/", 
  "https://publicotv.publicotv.workers.dev/", 
  "https://glittermprs.balofa5423.workers.dev/", 
  "https://tvcdntv.ebonie.workers.dev/", 
  "https://mikavi7999.mikavi7999.workers.dev/"
];
...
const channels = {
  ...
  'telecineaction': { 'url': randomLink + "telecineaction/tracks-v1a1/mono.m3u8" },
  'telecinefun': { 'url': randomLink + "telecinefun/tracks-v1a1/mono.m3u8" },
  'telecinepipoca': { 'url': randomLink + "telecinepipoca/tracks-v1a1/mono.m3u8" },
  'telecinepremium': { 'url': randomLink + "telecinepremium/tracks-v1a1/mono.m3u8" },
