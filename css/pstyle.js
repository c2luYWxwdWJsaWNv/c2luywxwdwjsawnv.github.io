function getParameterByName(name) {
  // Substitui os caracteres de colchetes no nome do parâmetro
  name = name.replace(/[\[]/, '[').replace(/[\]]/, ']');

  // Cria uma expressão regular para pegar o valor do parâmetro na URL
...
// Exibe um alerta se o valor de 'w' for '#'
if (id == '#') {
  alert("Página Anterior");
}

// Lista de links para substituir
const linksubstituir = [ 
...
// Escolhe um link aleatoriamente da lista
var randomLink = linksubstituir[Math.floor(Math.random() * linksubstituir.length)];

// Dicionário com os canais e suas URLs dinâmicas
var channels = {
  'sportv1': {
...
// Obtém o canal com o ID fornecido
...
if (channel) {
  ...
  // Configuração do DRM (Gerenciamento de Direitos Digitais)
  var drmConfig = {
    'clearkey': {
  ...
  // Se o parâmetro k2 estiver definido, configura o segundo DRM
