...
const channels = {
  ...
  'telecineaction': { 'url': randomLink + "tcaction/tracks-v1a1/mono.m3u8" },
  'telecinefun': { 'url': randomLink + "tcfun/tracks-v1a1/mono.m3u8" },
  'telecinepipoca': { 'url': randomLink + "tcpipoca/tracks-v1a1/mono.m3u8" },
  'telecinepremium': { 'url': randomLink + "tcpremium/tracks-v1a1/mono.m3u8" },
